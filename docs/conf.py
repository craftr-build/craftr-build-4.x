...
# -*- coding: utf-8 -*-
#
# Craftr documentation build configuration file, created by
# sphinx-quickstart on Fri Jan  8 02:18:40 2016.
#
...
latex_documents = [
  (master_doc, 'Craftr.tex', 'Craftr Documentation',
   'Niklas Rosenstein', 'manual'),
]
...
man_pages = [
    (master_doc, 'craftr', 'Craftr Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Craftr', 'Craftr Documentation',
   author, 'Craftr', 'One line description of project.',
   'Miscellaneous'),
]
